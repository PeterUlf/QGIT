<?php
    session_start();
$i=0;$options="<option value='kø-navn'>kø-navn</option>";
...
<html>
    <head>
        ...
        <style>
            *{padding: 0; margin: 0;}
            body, input, form, .knap, button {font-family: sans-serif; }
            ...
            img, iframe{width:29vw;}
            iframe{width: 40vw; height: 60vw; border: 0;}
            input[type=text], input[type=submit],input[type=password], select, textarea, button,.slet {
            ...
            input[type=text]:hover,input[type=submit]:hover, input[type=password]:hover, textarea:hover, button:hover, .slet:hover {
              box-shadow: 0 0 10px rgba(255,192,203, 1);
              padding: 5px 0px 5px 5px;
              margin: 5px 1px 5px 0px;
              border: 1px solid rgba(255,192,203, 1);position: relative;
            }
            .f-slet{display: inline-block;}
            #urlcontainer{font-size: 0.5em;}
